...
El snapshot `2026-07-22T23:32:46Z` confirma sus nueve columnas, ocho restricciones, tres índices propios —incluida la PK—, dos triggers, RLS sin políticas y ACL mínimo. La tabla forma parte del inventario vivo reconciliado posterior a 0009.
