...
| `activities` | Núcleo operativo de tutorías, asesorías y acompañamiento | `id`, `title`, `description`, `academic_period_id`, `program_id`, códigos de catálogos, ubicación, `starts_at`, `ends_at`, `responsible_profile_id`, `created_by`, `status_code` |
