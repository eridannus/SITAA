...
- El primer preflight remoto 0010 fue de sólo lectura, devolvió 34 categorías y terminó con `ROLLBACK`/código 0 sin cambios. No fue aprobado porque `dangerous_default_acl` contó 50 defaults estándar: 29 de 30 bloqueos sí fueron cero. El diagnóstico de sólo lectura confirmó cinco grupos de diez filas y también terminó con `ROLLBACK`/código 0.
