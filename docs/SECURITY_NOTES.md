...
### B.3a: límite Auth confiable desplegado; verificador y casos 1–18 aprobados
...
- B.3a permanece abierta: 1–12 están aprobados por la matriz central, 13–15 por failure/recovery v11, 16 por el verificador y 17–18 por concurrencia/límites v8. Los casos 19–20 son parciales: faltan bundles, variables y logs productivos, observación de la interfaz desplegada y smoke tests. También permanece pendiente la reconciliación post‑0010.
