...
- La segunda ejecución corregida quedó aprobada: 34 filas, sus 30 bloqueos en cero, `dangerous_default_acl = 0` y cuatro conteos informativos 1/4/0/0. Finalizó con `ROLLBACK`, código 0 y sin `ERROR`; no expuso datos sensibles ni cambió objetos, filas o privilegios. Esta aprobación no equivale a aplicación: 0010, su verificador, la Edge Function, Auth Admin y la matriz hospedada siguen pendientes y B.3a permanece abierta.
