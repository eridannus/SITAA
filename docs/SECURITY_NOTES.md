...
### B.3a: límite Auth confiable desplegado; verificador y matriz central aprobados
...
- La evidencia central y su postcheck fueron revisados sin correos, UUID, tokens, claves, contraseñas, URI, cookies, cabeceras `Authorization`, metadata sensible ni errores crudos. Los tokens y errores Auth crudos nunca se registran.
...
- B.3a permanece abierta: faltan pruebas hospedadas de fallos, concurrencia, usuarios ordinarios, límite `service_role`, cierre completo de ausencia de secretos, smoke tests y reconciliación post‑0010.
