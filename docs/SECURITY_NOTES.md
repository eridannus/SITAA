...
- La aplicación compatible fue desplegada, pero el primer intento de 0009 falló al compilar el preflight embebido por un paréntesis faltante. El fallo ocurrió antes de todo DDL y la transacción fue descartada: no existen objetos 0009 ni cambios de grants y no se requirió rollback. La migración corregida todavía no se ha reejecutado; 0009 permanece no aplicada y B.2b abierta.
