...
- La reejecución del preflight corregido permanece pendiente; no se aplicó 0009, no se ejecutaron verificador/rollback, no se generó snapshot post-0009 y B.2b no está cerrada.
- Estado: preparada localmente; no aplicada, no verificada mediante el verificador y no reconciliada. Durante esta corrección local no hubo conexión a Supabase ni ejecución SQL.
