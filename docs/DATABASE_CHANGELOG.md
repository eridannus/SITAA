...
- Estado: sintaxis corregida localmente; 0009 no aplicada, verificador/rollback no ejecutados y B.2b no reconciliada ni cerrada. La reejecución de la migración corregida permanece pendiente.
