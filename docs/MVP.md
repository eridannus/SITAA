...
- La migración asignada `0011` de `SEM-01` fue aplicada en producción el 2026-08-12 y su verificador transaccional corregido aprobó los casos 1–51 con `ROLLBACK` final explícito. El arnés multisesión y la reconciliación post-0011 permanecen pendientes; el snapshot rastreado todavía representa post-0010 y `/admin/periods` no existe.
