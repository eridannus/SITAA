...
export function CheckinCodeForm() {
  ...
  return <form action={action} onSubmit={(event) => {
    ...
    const validationMessage = typeof value === "string" ? validateCode(value) : "Escribe el código de asistencia.";
    ...
    <input id="checkin_code" name="checkin_code" required placeholder="mar-foco-papel" className="mt-2 w-full rounded-xl border border-slate-300 px-4 py-3 text-slate-900 outline-none transition focus:border-emerald-700 focus:ring-4 focus:ring-emerald-100" />
