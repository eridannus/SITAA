  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-10 sm:px-8 sm:py-14">
      ...
      <div className="sitaa-surface mt-4 rounded-3xl p-6 sm:p-9">
        <p className="text-sm font-bold uppercase tracking-[0.2em] text-[var(--sitaa-gold-dark)]">Profesor</p>
        <h1 className="mt-3 text-3xl font-bold text-[var(--sitaa-blue-dark)]">Comenzar registro de profesor</h1>
