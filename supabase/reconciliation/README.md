...
El snapshot autoritativo continúa siendo post‑0009 y no debe incorporar 0010 hasta después de una aplicación controlada, verificación, prueba desechable Auth y nueva reconciliación. 0010 sigue sin aplicar; el verificador no se ha ejecutado; la Edge Function sigue sin desplegar ni invocar; no hubo Auth Admin y las semánticas hospedadas de `ban_duration`/sesión permanecen sin verificar. B.3a continúa abierta. El siguiente paso autorizado es publicar y confirmar el despliegue del commit de aplicación compatible; después se despliega la Edge Function revisada y sólo entonces se aplican 0010 y su verificador. No se debe crear 0011 mientras 0010 permanezca abierta.
