...
La cadena cerrada actual es `0001`–`0006`; el siguiente número disponible es `0007`, sin reserva para una implementación concreta. Todo cambio futuro debe acompañarse de verificación y rollback cuando corresponda, aplicarse manualmente y registrarse en `docs/DATABASE_CHANGELOG.md`. Las migraciones cerradas no se reescriben salvo corrección de un artefacto histórico comprobado.
