...
La cadena cerrada actual sigue siendo `0001`–`0006`. `0007_admin_account_directory_audit.sql` está preparada localmente para Fase B.1, junto con preflight, verificador, rollback y plan de prueba, pero no se ha aplicado. El snapshot posterior a 0006 permanece vigente y no debe regenerarse hasta completar la secuencia coordinada de aplicación, despliegue, verificación y smoke tests. Los artefactos de `live/` son evidencia de reconciliación y no se editan para anticipar 0007.
