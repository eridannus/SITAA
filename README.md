...
B.2b está operativa mediante 0009: permite a una autoridad B.1 exacta desactivar o reactivar otra cuenta elegible, conserva asignaciones e historia y registra un evento append-only minimizado. La preparación B.3a añade localmente un ledger idempotente y una única Edge Function confiable para coordinar perfil y Auth sin secretos en Next.js. La barrera 0008 sigue negando operaciones de inmediato; no se afirma que los JWT ya emitidos se revoquen ni que la suspensión/restauración hospedada funcione hasta completar la prueba desechable obligatoria.
